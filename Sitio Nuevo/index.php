...
<head>
  ...
  <meta name="author" content="Fabricio Vega Ugalde">
  <meta name="description" content="Desarrollo de Sitios Web, Aplicaciones para dispositivos móviles, Sistemas Web">
  <meta name="keywords" content="Sitio Web, Aplicación Web, Sistema, SaaS, ERP, CRM, HubSpot, Software, Sistema, Website, mobile, app">

  <!-- Page Title -->
  <title>Fabricio Vega - Software Developer</title>
  <!-- Favicon Icon -->
...
<body id="home">
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            ...
            <a class="st-site-branding" href="index.html"><img src="assets/img/logo-149-40.png" alt="Fabricio Vega - Logo"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              ...
              <div class="sp-phone">
                ...
                <div class="sp-phone-no">+506 8708-2379</div>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="st-hero-wrap st-parallax">
      ...
      <div class="container">
        <div class="st-hero-text">
          ...
          <div class="st-hero-btn">
            <a href="#contact" class="st-btn st-style1 st-color1 st-smooth-move">Let's Talk</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="st-hero-img st-to-right">
      <img class="wow fadeInRight" src="assets/img/section/hero-img-850-850-2.jpg" alt="Hero">
      <div class="st-social-group wow fadeInLeft">
        <div class="st-social-link">
          <a target="_blank" href="https://www.facebook.com/fvegau.10/" class="st-social-btn active">
            <span class="st-social-icon"><i class="fab fa-facebook"></i></span>
            <span class="st-icon-name">Facebook</span>
          </a>
          <a target="_blank" href="https://www.instagram.com/fabriciovega" class="st-social-btn">
            <span class="st-social-icon"><i class="fab fa-instagram"></i></span>
            <span class="st-icon-name">Instagram</span>
          </a>
          <a target="_blank" href="https://api.whatsapp.com/send?phone=50687082379&text=%C2%A1Hola!%2C%20deseo%20conocer%20informaci%C3%B3n%20sobre%20tus%20servicios%20de%20Software" class="st-social-btn">
            <span class="st-social-icon"><i class="fab fa-whatsapp"></i></span>
            <span class="st-icon-name">WhatsApp</span>
          </a>
          <a target="_blank" href="https://www.linkedin.com/in/fabricio-vega-ugalde-890488105/" class="st-social-btn">
      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          <div class="st-about-img-wrap">
            <div class="st-about-img st-dynamic-bg st-bg" data-src="assets/img/section/about-570-514.jpg"></div>
          </div>
          ...
          <div class="st-vertical-middle">
            <div class="st-vertical-middle-in">
              <div class="st-text-block st-style1">
                <h2 class="st-text-block-title">Hi There! I'm Fabricio Vega</h2>
                <h4 class="st-text-block-subtitle">Software Developer</h4>
                <div class="st-text-block-text">
                  <p>I am passionate about software development. My mission is to support and collaborate in the facilitation and creation of wonderful tools that facilitate the digital operations of people and companies.</p>
                </div>
                <ul class="st-text-block-details st-mp0">
                  <li><span>Birthday</span> : <span>Oct 18, 1991</span></li>
                  <li><span>Phone</span> : <span>+506 8708-2379</span></li>
                  <li><span>Email</span> : <span>fabriciovu@gmail.com</span></li>
                  <li><span>From</span> : <span>Alajuela, Costa Rica</span></li>
                  <li><span>Language</span> : <span>English, Spanish</span></li>
                  <li><span>Freelance</span> : <span>Available</span></li>
                </ul>
                <div class="st-text-block-btn">
                  <a href="pdf/curriculum-vitae-fabricio-vega-ugalde.pdf" target="_blank" class="st-btn st-style1 st-color1">Download CV</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Logo</h2>
            <div class="st-iconbox-text">If you need to create a business brand, I can help you.</div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <div class="st-iconbox-text">I offer you pleasant systems and applications for users, taking care of every pixel and every location so that they have a good experience.</div>
          </div>
          <div class="st-height-b30 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">Digital Presence</h2>
            <div class="st-iconbox-text">I analyze, understand and implement techniques to improve your digital presence.</div>
          </div>
          <div class="st-height-b30 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <h2 class="st-iconbox-title">App Development</h2>
            <div class="st-iconbox-text">Development of mobile applications.</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <div class="st-iconbox-text">I help you create web software solutions tailored to your needs.</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
        <div class="col-lg-4 col-md-6">
          <div class="st-iconbox st-style1">
            ...
            <div class="st-iconbox-text">All my developments are tailored to different devices (cell phones, tablets, desktop computers, etc.).</div>
          </div>
          <div class="st-height-b0 st-height-lg-b30"></div>
        </div><!-- .col -->
      </div>
        ...
        <div class="col-lg-6">
          <div class="st-skill-wrap">
            <div class="st-skill-heading">
              <h2 class="st-skill-title">Below I highlight the main hard skills.</h2>
              <div class="st-skill-subtitle">
                I am passionate about always learning new technologies, each of them is very similar and the way it is implemented is like a book: it must be read and understood.
          ...
          <div class="st-progressbar-wrap">
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">.NET</h3>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">React Native</h3>
                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">60%</div>
              </div>
            ...
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">Branding</h3>
                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">50%</div>
              </div>
              <div class="st-progressbar" data-progress="50">
                <div class="st-progressbar-in wow fadeInLeft"></div>
              </div>
            </div><!-- .st-single-progressbar -->
            <div class="st-height-b30 st-height-lg-b20"></div>
            <div class="st-single-progressbar">
              <div class="st-progressbar-heading">
                <h3 class="st-progressbar-title">DevOps</h3>
      ...
      <div class="row">
          ...
          <div class="st-resume-wrap">
            ...
            <div class="st-resume-timeline-wrap">
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Software Developer</h3>
                <div class="st-resume-timeline-duration">Jan 2020 - Present</div>
                <h4 class="st-resume-timeline-subtitle">Banco Nacional de Costa Rica</h4>
                <div class="st-resume-timeline-text">
                  <p>Responsible for creating full stack web solutions.</p>
                </div>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Web Developer</h3>
                <div class="st-resume-timeline-duration">Jan 2016 - Present</div>
                <h4 class="st-resume-timeline-subtitle">Freelance</h4>
                <div class="st-resume-timeline-text">
                  <p>My favorite hobby is creating solutions, which is why I have developed more than 100 web applications, some of which are available on the web and are free.</p>
                </div>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Web Developer CMS</h3>
                <div class="st-resume-timeline-duration">Jan 2015 - December 2015</div>
                <h4 class="st-resume-timeline-subtitle">Dinterweb</h4>
                <div class="st-resume-timeline-text">
                  <p>In charge of programming websites that were functional for Wordpress, Joomla and Drupal. I mostly used PHP, html, css, js, jquery, bootstrap, among others..</p>
                </div>
              </div> <!-- st-resume-timeline -->
            </div>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="st-resume-wrap">
            ...
            <div class="st-resume-timeline-wrap">
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Bachelor's Degree in Software Engineering</h3>
                <div class="st-resume-timeline-duration">2023 - 2024</div>
                <h4 class="st-resume-timeline-subtitle">Universidad Internacional San Isidro Labrador - UISIL</h4>
              </div> <!-- st-resume-timeline -->
              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Diploma in Software Engineering</h3>
                <div class="st-resume-timeline-duration">2020 - 2022</div>
                <h4 class="st-resume-timeline-subtitle">Universidad Técnica Nacional - UTN</h4>
              </div> <!-- st-resume-timeline -->

              <div class="st-height-b50 st-height-lg-b30"></div>
              <div class="st-resume-timeline">
                <h3 class="st-resume-timeline-title">Bachelor's Degree in Business Administration</h3>
                <div class="st-resume-timeline-duration">2010 - 2014</div>
                <h4 class="st-resume-timeline-subtitle">Universidad de San José - USJ</h4>
              </div> <!-- st-resume-timeline -->
            </div>
          </div>
        </div>
            ...
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/portfolio1_lg.jpg" class="st-portfolio st-zoom st-lightbox-item">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/portfolio1.jpg" alt="Sitio Web Clínica Esperanza">
                </div>
                <div class="st-portfolio-item-hover">
                  <i class="fas fa-search"></i>
                  <h5>Website</h5>
                  <p>Implementation / Domain / SSL</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div class="st-portfolio-single st-style1 st-lightgallery">
            <div class="st-portfolio-item">
              <a href="assets/img/portfolio/portfolio2_lg.jpg" class="st-portfolio st-zoom st-lightbox-item">
                <div class="st-portfolio-img st-zoom-in">
                  <img src="assets/img/portfolio/portfolio2.jpg" alt="PassWhat">
                </div>
                <div class="st-portfolio-item-hover">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="st-contact-text">
            Just let me know, how can I collaborate with you?.
          </div>
          <div class="st-contact-info-wrap">
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Email</h4>
                <a href="mailto:fabriciovu@gmail.com">fabriciovu@gmail.com</a>
              </div>
            </div>
            <div class="st-single-contact-info">
              ...
              <div class="st-single-info-details">
                <h4>Phone</h4>
                <a 
                  href="https://api.whatsapp.com/send?phone=50687082379&text=%C2%A1Hola!%2C%20deseo%20conocer%20informaci%C3%B3n%20sobre%20tus%20servicios%20de%20Software"
                  target="_blank"
                  >+506 8708-2379</a>
              </div>
            </div>
  ...
  <footer>
    <div class="container">
      <div class="st-copyright-wrap text-center">
        <div class="st-copyright-text">© <?php echo date("Y"); ?> All right reserved.</div>
      </div>
    </div>
  </footer>
  <!-- End Footer Seciton -->
